...
export default function Experience() {
  ...
  return (
    <section id="experience" className="relative py-24">
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-px h-full bg-gradient-to-b from-transparent via-neon-cyan/10 to-transparent pointer-events-none" />
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <div className="relative">
          ...
          <div className="absolute start-6 sm:start-8 top-0 bottom-0 w-px bg-gradient-to-b from-neon-cyan/40 via-neon-purple/20 to-transparent" />
                ...
                >
                  ...
                  >
                    ...
                    <ul className="space-y-2">
                      {exp.highlights[locale].map((highlight, j) => (
                        <motion.li
                          key={j}
